					...
					<div class="room-wrap d-md-flex">
						...
						<div class="half left-arrow d-flex align-items-center">
							<div class="text p-4 p-xl-5 text-center">
								...
								<p class="mb-0"><span class="price mr-1">USD <?php echo $room->price; ?></span> <span class="per">per night</span></p>
								<h3 class="mb-3"><a href="rooms/room-single.php?id=<?php echo $room->id; ?>"><?php echo $room->name; ?></a></h3>
								<ul class="list-accomodation">
									<li><span>Maximum Occupancy :</span><?php echo $room->num_persons; ?></li>
									<li><span>Room Size:</span> <?php echo $room->size; ?><span> m²</span></li>
									<li><span>View:</span> <?php echo $room->view; ?></li>
									<li><span>Bed Type:</span> <?php echo $room->num_beds; ?></li>
								</ul>
